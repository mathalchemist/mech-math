// #def BORISENKO=LAMER: He doesn't know The C++ Standard Library and had written a lot of rubbish code!!!
...
public:
    ...
    {
        if (i < 0 || i >= len) throw OutOfRangeException("Index out of range");
        return str[i];
    }
...
public:
    ...
    public:
        ...
        TextLine& operator*() const { return (TextLine&) L2List::iterator::operator*(); }
    ...
    public:
        ...
        const TextLine& operator*() const { return ((iterator*) this)->operator*(); }
    ...
    const_iterator endBefore() const { return (const_iterator) L2List::endBefore(); }
    const_iterator beginAfter() const { return (const_iterator) L2List::beginAfter(); }
};
