...
/* YYPRHS[YYN] -- Index of the first RHS symbol of rule number YYN in
   YYRHS.  */
static const unsigned char yyprhs[] = {0,  0,  3,  4,  8,  11, 15, 19,
                                       23, 27, 31, 34, 37, 41, 43};

/* YYRHS -- A `-1'-separated list of the rules' RHS. */
static const yysigned_char yyrhs[] = {
    15, 0,  -1, -1, 15, 16, 5,  -1, 15, 5,  -1, 15, 1,  5,  -1,
    16, 10, 16, -1, 16, 9,  16, -1, 16, 12, 16, -1, 16, 11, 16,
    -1, 9,  16, -1, 10, 16, -1, 6,  16, 7,  -1, 3,  -1, 4,  -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const unsigned char yyrline[] = {0,  32, 32, 33, 36, 37, 40, 41,
...
static const unsigned char yyr1[] = {0,  14, 15, 15, 15, 15, 16, 16,
                                     16, 16, 16, 16, 16, 16, 16};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
static const unsigned char yyr2[] = {0, 2, 0, 3, 2, 3, 3, 3,
                                     3, 3, 2, 2, 3, 1, 1};

/* YYDEFACT[STATE-NAME] -- Default rule to reduce with in state
   STATE-NUM when YYTABLE doesn't specify something else to do.  Zero
   means the default is an error.  */
static const unsigned char yydefact[] = {2, 0, 1,  0, 13, 14, 4, 0, 0,
                                         0, 0, 5,  0, 10, 11, 3, 0, 0,
                                         0, 0, 12, 7, 6,  9,  8};

/* YYDEFGOTO[NTERM-NUM]. */
static const yysigned_char yydefgoto[] = {-1, 1, 10};

/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
#define YYPACT_NINF -8
static const yysigned_char yypact[] = {-8, 13, -8, -1, -8, -8, -8, 21, 21,
                                       21, 23, -8, -4, -8, 9,  -8, 21, 21,
                                       21, 21, -8, 9,  9,  -8, -8};

/* YYPGOTO[NTERM-NUM].  */
static const yysigned_char yypgoto[] = {-8, -8, -7};
...
static const unsigned char yytable[] = {
    12, 13, 14, 20, 11, 16, 17, 18, 19, 21, 22, 23, 24, 2, 3,  0,  4,  5,
    6,  7,  18, 19, 8,  9,  4,  5,  0,  7,  15, 0,  8,  9, 16, 17, 18, 19};

static const yysigned_char yycheck[] = {
    7, 8, 9,  7,  5, 9,  10, 11, 12, 16, 17, 18, 19, 0,  1, -1, 3,  4,
    5, 6, 11, 12, 9, 10, 3,  4,  -1, 6,  5,  -1, 9,  10, 9, 10, 11, 12};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const unsigned char yystos[] = {0,  15, 0, 1,  3,  4,  5, 6, 9,
                                       10, 16, 5, 16, 16, 16, 5, 9, 10,
                                       11, 12, 7, 16, 16, 16, 16};
