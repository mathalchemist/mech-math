...
// Written by VVB, Modified by rdmr
//
...
int main() {
  ...
  while (*line != 0) {
    ...
    try {
      if (strcmp(line, "+") == 0)
        ...
        onSin();
      else if (strcmp(line, "tan") == 0)
        onTan();
      else if (strcmp(line, "acos") == 0)
        onACos();
      else if (strcmp(line, "asin") == 0)
        onACos();
      else if (strcmp(line, "atan") == 0)
        onACos();
      else if (strcmp(line, "^") == 0)
        onPower();
      else if ((linelen > 0 && isdigit(line[0])) ||
  ...
  delete Stack; // <== THIS SHITTY LINE WAS FORGOTTEN BY VVB!!!!!!!!!!!!!!!!
  return 0;
}
