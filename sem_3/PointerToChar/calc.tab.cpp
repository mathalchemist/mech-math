...
/* YYPRHS[YYN] -- Index of the first RHS symbol of rule number YYN in
   YYRHS.  */
static const unsigned char yyprhs[] = {0,  0,  3,  4,  9,  12, 16,
                                       18, 22, 27, 30, 32, 34, 38};

/* YYRHS -- A `-1'-separated list of the rules' RHS. */
static const yysigned_char yyrhs[] = {
    13, 0,  -1, -1, 13, 15, 14, 6,  -1, 13, 6,  -1, 13, 1,
    6,  -1, 3,  -1, 7,  14, 8,  -1, 7,  10, 14, 8,  -1, 14,
    11, -1, 5,  -1, 4,  -1, 7,  15, 8,  -1, 15, 10, -1};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const unsigned char yyrline[] = {0,  32, 32, 33, 34, 35, 39,
...
static const char *const yytname[] = {
    "$end",    "error", "$undefined", "VAR",     "TYPE_INT", "TYPE_CHAR",
    "ENDL",    "LPAR",  "RPAR",       "ILLEGAL", "AST",      "BRACKETS",
    "$accept", "f",     "v",          "t",       0};
#endif
...
static const unsigned char yyr1[] = {0,  12, 13, 13, 13, 13, 14,
                                     14, 14, 14, 15, 15, 15, 15};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
static const unsigned char yyr2[] = {0, 2, 0, 4, 2, 3, 1, 3, 4, 2, 1, 1, 3, 2};

/* YYDEFACT[STATE-NAME] -- Default rule to reduce with in state
   STATE-NUM when YYTABLE doesn't specify something else to do.  Zero
   means the default is an error.  */
static const unsigned char yydefact[] = {2, 0,  1, 0,  11, 10, 4, 0, 0, 5, 0, 6,
                                         0, 13, 0, 12, 0,  0,  3, 9, 0, 7, 8};

/* YYDEFGOTO[NTERM-NUM]. */
static const yysigned_char yydefgoto[] = {-1, 1, 14, 8};

/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
#define YYPACT_NINF -5
static const yysigned_char yypact[] = {-5, 0,  -5, -4, -5, -5, -5, 20,
                                       5,  -5, 23, -5, 6,  -5, 8,  -5,
                                       14, 12, -5, -5, 21, -5, -5};

/* YYPGOTO[NTERM-NUM].  */
static const yysigned_char yypgoto[] = {-5, -5, 10, 3};
...
static const unsigned char yytable[] = {
    2,  3, 9,  0,  4,  5,  6,  7, 11, 11, 10, 0, 12, 12, 18, 13, 16,
    11, 0, 19, 21, 12, 17, 19, 4, 5,  20, 7,  0, 22, 0,  15, 19, 13};

static const yysigned_char yycheck[] = {
    0, 1,  6,  -1, 4, 5,  6,  7, 3, 3,  7, -1, 7, 7,  6, 10, 10,
    3, -1, 11, 8,  7, 12, 11, 4, 5, 16, 7, -1, 8, -1, 8, 11, 10};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const unsigned char yystos[] = {0,  13, 0,  1,  4,  5,  6,  7,
                                       15, 6,  15, 3,  7,  10, 14, 8,
                                       10, 14, 6,  11, 14, 8,  8};
