...
#define PLOT_X11_ERR_MSG_2                                                     \
  "Not enough memory to create X Windows data structures."
#define PLOT_X11_ERR_MSG_3                                                     \
  "Cannot allocate enough colors in the X Windows pallete."
