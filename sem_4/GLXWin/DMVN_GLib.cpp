...
static int AttrList_Double_Buf[] = {GLX_RGBA,
                                    GLX_DOUBLEBUFFER,
                                    GLX_RED_SIZE,
                                    8,
                                    GLX_GREEN_SIZE,
                                    ...
                                    32,
                                    None};
static int AttrList_Single_Buf[] = {GLX_RGBA, GLX_RED_SIZE,  8, GLX_GREEN_SIZE,
...
TXWin::TXWin(char *Title, int X, int Y, int Width, int Height, int RGBMode) {
  try {
    ...
    Win =
        XCreateSimpleWindow(Disp, DefaultRootWindow(Disp), X, Y, Width, Height,
