...
static int attributeListSgl[] = {GLX_RGBA, GLX_RED_SIZE,  8, GLX_GREEN_SIZE,
...
int main(int argc, char **argv) {
  ...
  win = XCreateWindow(dpy, RootWindow(dpy, vi->screen), 40, 40, 300, 300, 0,
  ...
  for (i = 0; i < 20; i++) {
    ...
    glTranslatef((GLfloat)rand() / RAND_MAX - 0.5,
